...
var options = {
	...
	"APPEARENCE": {
		...
		"EDIT LEFT NOTE COLOR": ["noteColorLeft", "Enables note color customization.", false],
		"EDIT DOWN NOTE COLOR": ["noteColorDown", "Enables note color customization.", false],
		"EDIT UP NOTE COLOR": ["noteColorUp", "Enables note color customization.", false],
		"EDIT RIGHT NOTE COLOR": ["noteColorRight", "Enables note color customization.", false],
	},
	"MISC": {
		"FREEPLAY PREVIEW": ["freeplaySongPreview", "Enable preview for selected songs in Freeplay.\nReduces loading times a shit ton.", true],
